...
| `SAVE_CONVERSATIONS`                         | Whether to save the ongoing telegram conversation to a file.                                                                                                                                                                          | `false`                            |
| `CONVERSATIONS_FILE`                         | Which file to use to store ongoing conversations into. Ignored if `SAVE_CONVERSATIONS` is `false`.                                                                                                                                                                     | `storage/conversations.json`                            |
